   ...
   static boolean playBlackjack() {
      ...
      */
      ...
      if (manoCrupier.getValorBlackjack()== 21) {
          String m="El distribuidor tiene el " + manoCrupier.getCarta(0) + " y el " + manoCrupier.getCarta(1) + ".\n"
      ...
      if (manoUsuario.getValorBlackjack()== 21) {
          String m1 = "El distribuidor tiene el " + manoCrupier.getCarta(0) + " y el " + manoCrupier.getCarta(1) + ".\n"
                      + "El usuario tiene el " + manoUsuario.getCarta(0) + " y el " + manoUsuario.getCarta(1) + ".\n"
           ...
           if ( opcion == 'S' ) {
               ...
               if (manoUsuario.getValorBlackjack()> 21) {
                   ...
                   JOptionPane.showMessageDialog(null, "Pasaste por encima de los 21.  Tú pierdes.\n"
                                                       + "La otra carta del repartidor era el " + manoCrupier.getCarta(1));
                   return false;  
               }
           }
      ...
      */
      ...
      JOptionPane.showMessageDialog(null, "El total del distribuidor es " + manoCrupier.getValorBlackjack());
      ...
      if (manoCrupier.getValorBlackjack()== manoUsuario.getValorBlackjack()) {
         ...
         JOptionPane.showMessageDialog(null, "El concesionario gana, " + manoCrupier.getValorBlackjack()
                          + " puntos para " + manoUsuario.getValorBlackjack()+ ".");
         return false;
      }
      else {
        
         JOptionPane.showMessageDialog(null, "Tu ganas, " + manoUsuario.getValorBlackjack()
                          + " puntos para " + manoCrupier.getValorBlackjack()+ ".");
         return true;
      }
