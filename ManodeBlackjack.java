 ...
 * @author Ferchitoo
 */
public class ManodeBlackjack extends Mano{
//    / **
...
//     * /
    public int getValorBlackjack() {
        ...
        val = 0;
        as = false;
        cartas = getCartasContador();  // (method defined in class Hand.)
        ...
        for ( int i = 0;  i < cartas;  i++ ) {
            ...
            if (cartaVal > 10) {
                cartaVal = 10;  // Para un Jack, Reina o Rey.
            }
            if (cartaVal == 1) {
    ...
    }  // fin obtiene el valor de la carta()
